// code original par Jacob Seidelin, adapté pour les besoins du projet
var ascii = (function() {
	function asciiFromCanvas(canvas, options) {
		...
		for (var y = 0; y < canvasHeight; y += 2) {
			for (var x = 0; x < canvasWidth; x++) {
				// récupère la luminosité de chaque pixel et retourne la char correspondant
				// get each pixel's brightness and output corresponding character
				var offset = (y * canvasWidth + x) * 4;
				var color = getColorAtOffset(imageData.data, offset);
				
				// augmente le contraste de l'image pour que la représentation ascii soit plus joulie
				// http://www.dfstudios.co.uk/articles/image-processing-algorithms-part-5/
				var contrastedColor = {
				...
				// calcule la luminosité du pixel
